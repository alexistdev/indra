    ...
    <div class="row justify-content-center">
        <div class="col-lg-5">
            <div class="card shadow-lg border-0 rounded-lg mt-3">
                ...
                <div class="card-body">
                    <form action="<?= base_url('kategori/editKategori/'.$data['id']); ?>" method="POST">
                        <div class="form-group">
                            <label class="mb-1" for="kategori">Kategori</label>
                            <input class="form-control py-4" id="kategori" name="kategori" type="text" placeholder="input nama kategori..." value="<?= $data['kategori']; ?>"/>
